...
public class Importance {
	...
	public static void calcMethodImp(ClassOrInterfaceDeclaration declaration, List<Method> allMethods, MethodRepository method_Repository)
	{
	...
	public static void calcAttrImp(ClassOrInterfaceDeclaration declaration, List<Attribute> allAttributes, AttributeRepository attribute_Repository)
	{
        ...
        for (int x=0; x<allAttributes.size();x++)
        {
        	...
        	float imp2= calcAttrImp1(allAttributes.get(x));
	...
	public static float calcAttrImp1(Attribute attribute)
	{
		float sum=0;
